...
export default function Sidebar() {
  ...
  return (
    <>
      <aside className="flex h-full w-16 shrink-0 flex-col items-center border-r border-zinc-800/80 bg-[#0d0d10] py-4">
        <button
      ...
      {expanded && (
        <div className="fixed inset-0 z-30 flex">
          ...
          />
          <aside className="relative z-40 flex h-full w-72 flex-col bg-[#0d0d10] p-3">
            ...
            <ExpandedRow icon={PenSquare} label="New chat" />
            <ExpandedRow icon={Search} label="Search chats" />
            <div className="my-2 h-px bg-zinc-800" />
            <ExpandedRow icon={Star} label="Get more points" />
            <ExpandedRow icon={Compass} label="Explore" />
            <ExpandedRow icon={Grid2x2} label="Bots" />
            <ExpandedRow icon={TrendingUp} label="Leaderboard" />
            <ExpandedRow icon={SquarePlus} label="Create" />
            <ExpandedRow icon={Package} label="Creator earnings" />
          </aside>
        </div>
      )}
    </>
...
function ExpandedRow({ icon: Icon, label }: NavItem) {
  return (
    <button className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-left text-[15px] font-medium text-zinc-100 hover:bg-zinc-800">
